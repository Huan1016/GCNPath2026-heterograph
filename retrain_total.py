...
from utils.heterograph_data import load_heterograph_data, load_heterograph_pairs
...
def parse_parameter() :
    ...
    parser.add_argument("-e", type=int, default=100, help="Epochs (Default: 100)")
...
if args.model == "baseline" :
    ...
    args = get_cell_info(args, sample_cell)   # [1, 16, 16, 16]
    ...
    train_loader = load_heterograph_pairs(ic50_data, heterograph, args, no_labels, batch_size, num_workers, shuffle=True)
